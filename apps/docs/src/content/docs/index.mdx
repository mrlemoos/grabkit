---
title: TypeScript HTTP client
description: TypeScript HTTP client for explicit METHOD /path calls. JSON:API by default; plain JSON with format "json". Tuple results and optional key casing.
template: splash
head:
  - tag: meta
    attrs:
